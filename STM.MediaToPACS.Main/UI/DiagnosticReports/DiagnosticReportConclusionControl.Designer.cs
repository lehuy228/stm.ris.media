...
namespace STM.MediaToPACS.Main.UI.DiagnosticReports
{
    partial class DiagnosticReportConclusionControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            // AutoSize thay vì Width cố định: số nút viewer PACS thay đổi tuỳ bác sĩ đăng nhập
            // (RenderViewerButtons ở DiagnosticReportConclusionControl.Viewer.cs) nên bề rộng
            // vùng nút phải tự co giãn theo đúng số nút đang có, không bị cắt/thừa chỗ.
            ...
            this._cbHoverPreview.Text = "Xem trước khi hover";

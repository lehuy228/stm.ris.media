...
namespace STM.MediaToPACS.Main.UI
{
    ...
    class ListImageBox : System.Windows.Forms.FlowLayoutPanel
    {
        ...
        public ListImageBox()
        {
            ...
            // cho phép scroll vertical khi item quá cao
            this.VerticalScroll.Visible = true;
            this.VerticalScroll.Enabled = true;

            // nhưng chủ yếu scroll ngang
            ...
            System.IO.Stream file =
                thisExe.GetManifestResourceStream("STM.MediaToPACS.Main.Images.Plus.PNG");
            imgPlus = Image.FromStream(file);
            file =
                thisExe.GetManifestResourceStream("STM.MediaToPACS.Main.Images.Minus.PNG");
        ...
        private void DeleteItemCondensed(int index)
        {
            ...
            {
                ScrollControlIntoView(Items[index - 1]._Controls);
            }
            else
            {
                ScrollControlIntoView(Items[index]._Controls);
            }
        ...
        private void AddItemExpanded(ImageCollection imagecollection)
        {
            ...
            foreach (ImageItem img in imagecollection.Images)
            {
                ...
                this.ScrollControlIntoView(PanelItem);
                if (img.Checked)

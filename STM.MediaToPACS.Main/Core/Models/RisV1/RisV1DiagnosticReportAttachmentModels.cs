...
namespace MediaToPacs.Core.Models
{
    ...
    public class DiagnosticReportAttachmentDestinationDto
    {
        ...
        // API danh sách destinations trả lỗi ở field "lastError" (khác "errorDetail" của response
        // pacs-push) - map thêm property trùng tên để System.Text.Json tự bind, dùng ErrorMessage
        // (fallback errorDetail rồi lastError) khi đọc.
        public string lastError { get; set; }

        public string ErrorMessage => !string.IsNullOrWhiteSpace(errorDetail) ? errorDetail : lastError;
    }

...
#if LTV17_CONFIG
   #if !FOR_WIN64
            printerName = "LEADTOOLS 17 PrintToPACS 32-bit";
   #else
            printerName = "LEADTOOLS 17 PrintToPACS 64-bit";
   #endif
#endif
#if LTV175_CONFIG
   #if !FOR_WIN64
            printerName = "LEADTOOLS 17.5 PrintToPACS 32-bit";
   #else
            printerName = "LEADTOOLS 17.5 PrintToPACS 64-bit";
   #endif
#endif
#if LTV18_CONFIG
#if !FOR_WIN64
            printerName = "LEADTOOLS 18 PrintToPACS 32-bit";
#else
            printerName = "LEADTOOLS 18 PrintToPACS 64-bit";
#endif
#endif
#if LTV19_CONFIG
#if !FOR_WIN64
            printerName = "LEADTOOLS 19 PrintToPACS 32-bit";
#else
            printerName = "LEADTOOLS 19 PrintToPACS 64-bit";
#endif
#endif
...
#if !FOR_WIN64
         settingsFilename = commonFolder + @"\PrintToPACSDemo_32_175.xml";
#else
         settingsFilename = commonFolder + @"\PrintToPACSDemo_64_175.xml";
#endif
#else
#if !FOR_WIN64
         settingsFilename = commonFolder + @"\PrintToPACSDemo_32.xml";
#else
         settingsFilename = commonFolder + @"\PrintToPACSDemo_64.xml";
#endif
#endif

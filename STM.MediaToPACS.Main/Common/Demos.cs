   ...
   public static class DemosGlobal
   {
      ...
      public static string ImagesFolder
      {
         get
         {
            ...
            string unicodeImagesPath = @"Software\LEAD Technologies, Inc.\19\UnicodeImages";
      ...
      public static void SetDefaultComments(RasterImage rasterImage, RasterCodecs rasterCodecs)
      {
         ...
         commentCopyright.FromAscii("Copyright (c) 1991-2014 LEAD Technologies, Inc.  All Rights Reserved.");
      ...
      public static void LaunchHelp2(string topicName)
      {
         ...
         startInfo.Arguments = String.Format("/viewalt:{0} {1} ", topicName);
#if LTV19_CONFIG
         int ver = 19;

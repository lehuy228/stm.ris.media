    ...
    public static class Support
    {
        ...
        public static void SetLicense()
        {
            try
            {
                ...
                string pathKey = Path.Combine(exeFolder, "full_license.key");
                string pathLic = Path.Combine(exeFolder, "full_license.lic");

                var key = File.ReadAllText(pathKey);
                var lic = File.ReadAllBytes(pathLic);

   ...
   public class AboutDialog : Form
   {
      ...
      private void AboutDialog_Load(object sender, System.EventArgs e)
      {
         ...
         if (!Is64Process())
            ...
            platform = "64";
         _tb1.Text = string.Format("LEADTOOLS .NET C# {0} Demo {1}{2}{2}{2}Copyright © 1991-2014 ALL RIGHTS RESERVED.{2}LEAD Technologies, Inc.", _demoName, platform, Environment.NewLine);
         CenterToParent();
      }
   }
}

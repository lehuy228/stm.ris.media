...
namespace MediaToPacs.Infrastructure.Services
{
    public class RisService : IRisService
    {
        ...
        public async Task<DiagnosisResultResponse> TaoKetQuaChanDoanAsync(DiagnosisResultRequest request)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                try
                {
                    var apiResult = System.Text.Json.JsonSerializer.Deserialize<ApiResponse<DiagnosisResultResponse>>(
                        responseContent,
        ...
        public async Task<DiagnosisResultResponse> GetKetQuaChanDoanAsync(string maChiDinh)
        {
            ...
            var apiResponse = JsonConvert.DeserializeObject<ApiResponse<DiagnosisResultResponse>>(json);
           ...
           DateTime? dateTimeTo = null)
        {
            ...
            string content = await response.Content.ReadAsStringAsync();
            var responseObj = JsonConvert.DeserializeObject<ResultPage<ServiceOrderResponse>>(content, settings);

            return responseObj ?? new ResultPage<ServiceOrderResponse>();
        }

        public async Task<ServiceOrderResponse> GetChiDinhDichVuAsync(string maChiDinh)
        {
            ...
            var result = System.Text.Json.JsonSerializer.Deserialize<ServiceOrderResponse>(
                content,
        ...
        public async Task<ResultPage<ConclusionSuggestionGridView>> GetDanhSachGoiYKetLuanAsync(int page = 1, int pageSize = 50, string madichvu = null)
        {
            var filters = new List<FilterItem>();
            ...
            string content = await response.Content.ReadAsStringAsync();
            var responseObj = JsonConvert.DeserializeObject<ResultPage<ConclusionSuggestionResponse>>(content, settings);

            var dataGridList = new List<ConclusionSuggestionGridView>();

            foreach (var x in responseObj.data)
            {
                try
                {
                    dataGridList.Add(new ConclusionSuggestionGridView
                    {
                        name = x.name,
            ...
            return new ResultPage<ConclusionSuggestionGridView>
            {
        ...
        public async Task<ResultPage<ConclusionSuggestionResponse>> GetDanhSachConclusionSuggestionResponseAsync(int page = 1, int pageSize = 50, string madichvu = null)
        {
            var filters = new List<FilterItem>();
            ...
            return responseObj ?? new ResultPage<ConclusionSuggestionResponse>();
        }


        public async Task<ConclusionSuggestionResponse> TaoMoiGoiYKetLuanAsync(ConclusionSuggestionRequest request)
        {
            var json = System.Text.Json.JsonSerializer.Serialize(request);
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            ...
            var result = System.Text.Json.JsonSerializer.Deserialize<ConclusionSuggestionResponse>(
                responseContent,
                new System.Text.Json.JsonSerializerOptions
                {
                    PropertyNameCaseInsensitive = true
        ...
        public async Task<ConclusionSuggestionResponse> CapNhatGoiYKetLuanAsync(ConclusionSuggestionRequest request, string id)
        {
            var json = System.Text.Json.JsonSerializer.Serialize(request);
            var content = new StringContent(json, Encoding.UTF8, "application/json");
        ...
        public async Task<ConclusionSuggestionResponse> GetGoiYKetLuanById(string id)
        {
        ...
        //Danh sách dịch vụ
        public async Task<ResultPage<ServiceCatalogResponse>> GetDSDichVuAsync(int page = 1, int pageSize = 500, string modality = null)
        {
            var filters = new List<FilterItem>();
            if (!string.IsNullOrWhiteSpace(modality))
                filters.Add(new FilterItem { Field = "modality", Operator = "eq", Value = modality });
            ...
            string content = await response.Content.ReadAsStringAsync();
            var responseObj = JsonConvert.DeserializeObject<ResultPage<ServiceCatalogResponse>>(content, settings);

            return responseObj ?? new ResultPage<ServiceCatalogResponse>();
        }

        public async Task<List<ServiceCatalogGridView>> GetDanhSachDichVuAsync(int page = 1, int pageSize = 500, string modality = null, string tenDichVu = null, string maDichVu = null)
        {
            var filters = new List<FilterItem>();
            if (!string.IsNullOrWhiteSpace(modality))
                filters.Add(new FilterItem { Field = "modality", Operator = "contains", Value = modality });
            ...
            var dataGridList = new List<ServiceCatalogGridView>();

            foreach (var x in responseObj.data)
            {
                try
                {
                    dataGridList.Add(new ServiceCatalogGridView
                    {
                        madichvu = x.madichvu,
            ...
            return dataGridList ?? new List<ServiceCatalogGridView>();
        }

        public async Task<ServiceCatalogResponse> GetDichVuAsync(string maDichVu)
        {
            ...
            var result = System.Text.Json.JsonSerializer.Deserialize<ServiceCatalogResponse>(
                content,
                new System.Text.Json.JsonSerializerOptions
                {
                    PropertyNameCaseInsensitive = true
        ...
        public async Task<ResultPage<DeviceResponse>> GetDSThietBiAsync(
             int page = 1,
             int pageSize = 500,
             string loaiThietBi = null)
        {
            ...
            //string content = await response.Content.ReadAsStringAsync();
            //var responseObj = JsonConvert.DeserializeObject<ResultPage<DeviceResponse>>(content, settings);
            ...
            return responseObj ?? new ResultPage<DeviceResponse>();
        }
        #endregion
        ...
        public async Task<Patient> GetPatientAsync(string maBenhNhan)
        {
            ...
            var respon = System.Text.Json.JsonSerializer.Deserialize<ResponseResult<Patient>>(json,
                new JsonSerializerOptions
                {
                    PropertyNameCaseInsensitive = true
                });
        ...
        public async Task<ServiceOrderResponse> UpdateChiDinhDichVu(string maChiDinh, Patient Patient)
        {
            ...
            var body = new
            {
                Patient = new
                {
                    ...
                    hoten = Patient.HoTen,
                    tungaybhyt = Patient.TuNgayBHYT,
                    denngaybhyt = Patient.DenNgayBHYT,
                    mabhyt = Patient.MaBHYT,
                    xaphuong = Patient.XaPhuong,
                    tinhthanh = Patient.TinhThanh,
            ...
            var result =
                JsonConvert.DeserializeObject<ResponseResult<ServiceOrderResponse>>(json);

...
namespace PrintToPACSDemo.AnPhat.Data
{
    public class TypeConvertor
    {
        ...
        static TypeConvertor()
        {
            ...
            _DbTypeList.Add(new DbTypeMapEntry(typeof(float), DbType.Single, SqlDbType.Real));
            ...
            _DbTypeList.Add(new DbTypeMapEntry(typeof(short), DbType.Int16, SqlDbType.SmallInt));
            _DbTypeList.Add(new DbTypeMapEntry(typeof(int), DbType.Int32, SqlDbType.Int));
